...
public class ruleScreen3Controller implements Initializable {
     ...
     */
    @FXML
    private void handleBackButtonAction(final ActionEvent event) { Main.setBoardScene();
    }
    ...
    public void initialize(final URL url, final ResourceBundle rb) {
        ...
        text.setFont(Font.font("Century Gothic Bold", FontWeight.BOLD, 35));
    }
}
